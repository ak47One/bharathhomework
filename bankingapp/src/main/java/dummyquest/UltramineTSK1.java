...
public class UltramineTSK1 {
	 ...
	 * 
	 * LocalDate myDate = LocalDate.of(2024, 8, 2); boolean isDateAfter =
	 * myDate.isAfter(fltDate); boolean isDateBefore = myDate.isBefore(fltDate);
	 * 
	 * 
	 * System.out.println("is Date After" + isDateBefore);
	 * System.out.println("is Date After" + isDateAfter); // Using traditional for
	 * loop to filter the order list List<Order> finalOrderList = new ArrayList<>();
